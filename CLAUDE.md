...
7. The product is WEB-ONLY. The responsive design must keep supporting mobile/tablet browsers, but there are no separate Mobile or Electron apps — never create or maintain code for them.
